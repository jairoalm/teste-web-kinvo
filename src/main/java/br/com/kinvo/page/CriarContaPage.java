...
public class CriarContaPage extends BasePage {
	...
	public void clicar_Recaptcha(){
		...
		new WebDriverWait(DriverFactory.getDriver(), 10).until(ExpectedConditions.frameToBeAvailableAndSwitchToIt
				(By.xpath("//iframe[starts-with(@name, 'a-') and starts-with(@src, 'https://www.google.com/recaptcha')]")));
		new WebDriverWait(DriverFactory.getDriver(), 20).until(ExpectedConditions.
